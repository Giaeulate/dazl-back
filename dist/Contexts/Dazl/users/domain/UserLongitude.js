...
class UserLongitude extends StringValueObject_1.StringValueObject {
    constructor(value) {
        super(value);
        this.value = value;
...
exports.UserLongitude = UserLongitude;
//# sourceMappingURL=UserLongitude.js.map