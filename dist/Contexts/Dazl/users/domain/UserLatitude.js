...
class UserLatitude extends StringValueObject_1.StringValueObject {
    constructor(value) {
        super(value);
        this.value = value;
...
exports.UserLatitude = UserLatitude;
//# sourceMappingURL=UserLatitude.js.map