...
let UserLiveActive = class UserLiveActive {
    ...
    async run({ userId }) {
        ...
        const userLive = usersLive.find((user) => user.status.value === 'inactive' || user.status.value === 'holding');
...
UserLiveActive = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, common_1.Inject)(constants_1.USER_LIVE_REPOSITORY)),
    __metadata("design:paramtypes", [Object])
], UserLiveActive);
exports.UserLiveActive = UserLiveActive;
//# sourceMappingURL=UserLiveActive.js.map