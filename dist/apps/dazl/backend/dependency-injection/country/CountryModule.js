...
const GetCountryController_1 = require("../../controllers/GetCountryController");
let CountryModule = class CountryModule {
};
CountryModule = __decorate([
    (0, common_1.Module)({
        imports: [],
        providers: [CountryAllSearcher_1.CountryAllSearcher],
        controllers: [GetCountryController_1.GetCountryController],
        exports: [],
    })
], CountryModule);
exports.CountryModule = CountryModule;
//# sourceMappingURL=CountryModule.js.map